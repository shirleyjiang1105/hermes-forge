...
const PRESET_SETTINGS_CONFIG: Partial<Record<ModelSourceType, ProviderPreset["settingsConfig"]>> = {
  ...
  tencent_token_plan_api_key: {
    env: {
      ...
      AI_API_KEY: "${api_key}",
      AI_PROVIDER: "custom",
      OPENAI_BASE_URL: "https://api.lkeap.cloud.tencent.com/plan/v3",
      AI_BASE_URL: "https://api.lkeap.cloud.tencent.com/plan/v3",
    },
  },
  tencent_hunyuan_token_plan_api_key: {
    env: {
      ...
      AI_BASE_URL: "https://tokenhub.tencentmaas.com/plan/v3",
    },
  },
...
export const PROVIDERS: ProviderPreset[] = [
  ...
  provider("dashscope_coding_api_key", "通义千问 Coding Plan", "china", "需要 API Key", "https://coding-intl.dashscope.aliyuncs.com/v1", undefined, "填写 DashScope Coding 模型 ID", "required", Code2, "阿里云 Coding Plan 专用接口", ["通义", "dashscope", "coding"], "Coding Plan", "api_key", undefined, ["coding_plan"]),
  provider("zhipu_coding_api_key", "智谱 Coding Plan", "china", "需要 API Key", "https://open.bigmodel.cn/api/coding/paas/v4", undefined, "填写智谱 Coding 模型 ID", "required", Code2, "智谱 Coding Plan 专用接口", ["智谱", "glm", "coding"], "Coding Plan", "api_key", undefined, ["coding_plan"]),
  ...
  provider("tencent_token_plan_api_key", "腾讯云通用 Token Plan", "china", "需要 API Key", "https://api.lkeap.cloud.tencent.com/plan/v3", undefined, "填写腾讯云 Token Plan 模型 ID", "required", Code2, "腾讯云通用 Token Plan 接口", ["腾讯", "tencent", "token-plan"], "Coding Plan", "api_key", undefined, ["coding_plan"]),
  provider("tencent_hunyuan_token_plan_api_key", "腾讯云 Hy Token Plan", "china", "需要 API Key", "https://tokenhub.tencentmaas.com/plan/v3", undefined, "填写腾讯 Hy Token Plan 模型 ID", "required", Code2, "腾讯云混元 Token Plan 接口", ["腾讯", "hunyuan", "token-plan"], "Coding Plan", "api_key", undefined, ["coding_plan"]),
  provider("minimax_token_plan_api_key", "MiniMax Token Plan", "china", "需要 API Key", "https://api.minimaxi.com/v1", undefined, "填写 MiniMax Token Plan 模型 ID", "required", Code2, "MiniMax Token Plan 接口", ["minimax", "token-plan"], "Coding Plan", "api_key", undefined, ["coding_plan"]),
  provider("kimi_coding_api_key", "Kimi Coding Plan", "china", "需要 API Key", "https://api.kimi.com/coding/v1", undefined, "填写 Kimi Coding 模型 ID", "required", Code2, "Kimi Coding Plan 专用接口", ["kimi", "coding"], "Coding Plan", "api_key", undefined, ["coding_plan"]),
